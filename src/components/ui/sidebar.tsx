...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full text-title px-4 py-4 hidden md:flex bg-secondary-700 md:flex-col ease-in-out flex-shrink-0 fixed top-0 right-0",
          className
        )}
        animate={{
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-heading-1 font-extrabold text-secondary-400 group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </Link>
